...
async function refreshTemplatePokeCard(id, imageForFav, imageForCatch){
  ...
  <div onclick="ignorclick(event)" class="pokemonCardMenu">
    ...
    <ul onclick="ignorclick(event)">
      <li onclick="ignorclick(event), playAudio('${id}')" class="audio"><img src="./img/icons/volume-up-fill.png" onclick="playAudio('${id}')"></li>
      <li onclick="ignorclick(event), switchIsliked('${id}')" class="fav"><img src="${imageForFav}" onclick="switchIsliked('${id}')"></li>
      <li onclick="ignorclick(event), switchIsCaught('${id}')" class="team"><img src="${imageForCatch}" onclick="switchIsCaught('${id}')"></li>
    </ul>
  </div>
